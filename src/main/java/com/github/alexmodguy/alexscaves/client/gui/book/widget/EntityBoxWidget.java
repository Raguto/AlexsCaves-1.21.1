...
public class EntityBoxWidget extends EntityWidget {
    ...
    private void renderQuad(PoseStack poseStack, VertexConsumer vertexconsumer, float x0, float x1, float y0, float y1, float u0, float u1, float v0, float v1){
        ...
        vertexconsumer.addVertex(matrix4f, x0, y0, 0.0F).setColor(1.0F, 1.0F, 1.0F, 1.0F).setUv(scaledU1, scaledV0).setOverlay(NO_OVERLAY).setLight(240).setNormal(posestack$pose, 0.0F, 1.0F, 0.0F);
        vertexconsumer.addVertex(matrix4f, x1, y0, 0.0F).setColor(1.0F, 1.0F, 1.0F, 1.0F).setUv(scaledU0, scaledV0).setOverlay(NO_OVERLAY).setLight(240).setNormal(posestack$pose, 0.0F, 1.0F, 0.0F);
        vertexconsumer.addVertex(matrix4f, x1, y1, 0.0F).setColor(1.0F, 1.0F, 1.0F, 1.0F).setUv(scaledU0, scaledV1).setOverlay(NO_OVERLAY).setLight(240).setNormal(posestack$pose, 0.0F, 1.0F, 0.0F);
        vertexconsumer.addVertex(matrix4f, x0, y1, 0.0F).setColor(1.0F, 1.0F, 1.0F, 1.0F).setUv(scaledU1, scaledV1).setOverlay(NO_OVERLAY).setLight(240).setNormal(posestack$pose, 0.0F, 1.0F, 0.0F);
    }
}
