...
public class WatcherAppearanceParticle extends Particle {
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float partialTick) {
        ...
        VertexConsumer vertexconsumer = multibuffersource$buffersource.getBuffer(NeoForgeRenderTypes.getUnlitTranslucent(TEXTURE));
        this.model.positionForParticle(partialTick, age);
        this.model.renderToBuffer(posestack, vertexconsumer, 240, OverlayTexture.NO_OVERLAY, net.minecraft.util.FastColor.ARGB32.colorFromFloat(Mth.clamp(1 - f * f, 0F, 1F), 1.0F, 1.0F, 1.0F));
