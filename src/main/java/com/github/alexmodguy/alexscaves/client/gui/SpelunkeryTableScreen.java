...
public class SpelunkeryTableScreen extends AbstractContainerScreen<SpelunkeryTableMenu> {
    ...
    private void renderMagnify(GuiGraphics guiGraphics, float partialTick) {
        ...
        bufferbuilder.addVertex(matrix4f, (float) x0, (float) y0, (float) zOffset).setUv(u0, v0);
        bufferbuilder.addVertex(matrix4f, (float) x0, (float) y1, (float) zOffset).setUv(u0, v1);
        bufferbuilder.addVertex(matrix4f, (float) x1, (float) y1, (float) zOffset).setUv(u1, v1);
        bufferbuilder.addVertex(matrix4f, (float) x1, (float) y0, (float) zOffset).setUv(u1, v0);
