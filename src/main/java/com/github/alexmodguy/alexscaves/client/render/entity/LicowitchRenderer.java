    ...
    public static void renderEntireBatch(LevelRenderer levelRenderer, PoseStack posestack, int renderTick, Camera camera, float partialTick) {
        for (LicowitchEntity licowitch : allTeleportingLicowitchOnScreen) {
            ...
            if (to != null && progress > 0) {
                ...
                int argb1 = ((int)(progress * 255) << 24) | ((int)(1.0F * 255) << 16) | ((int)((1.0F - (1F - progress)) * 255) << 8) | (int)(1.0F * 255);
                TELEPORTING_MODEL.renderToBuffer(posestack, textureBuffer, 240, LivingEntityRenderer.getOverlayCoords(licowitch, 0.0F), argb1);
                ...
                int argb2 = ((int)(progress * 255) << 24) | ((int)(1.0F * 255) << 16) | ((int)(0.0F * 255) << 8) | (int)(1.0F * 255);
                TELEPORTING_MODEL.renderToBuffer(posestack, witchEffectBuffer, 240, LivingEntityRenderer.getOverlayCoords(licowitch, 0.0F), argb2);
                posestack.popPose();
            }
        }
            ...
            if (progress > 0.0F) {
                ...
                if (to != null) {
                    ...
                    if (vec3.length() > 0.5F) {
                        ...
                        int argb1 = ((int)(progress * 255) << 24) | ((int)(1.0F * 255) << 16) | ((int)((1.0F - progress) * 255) << 8) | (int)(1.0F * 255);
                        this.getParentModel().renderToBuffer(poseStack, textureBuffer2, packedLightIn, LivingEntityRenderer.getOverlayCoords(witch, 0.0F), argb1);
                        ...
                        int argb2 = ((int)(progress * 255) << 24) | ((int)(1.0F * 255) << 16) | ((int)(0.0F * 255) << 8) | (int)(1.0F * 255);
                        this.getParentModel().renderToBuffer(poseStack, witchEffectBuffer2, packedLightIn, LivingEntityRenderer.getOverlayCoords(witch, 0.0F), argb2);
                    }
                }
            }
