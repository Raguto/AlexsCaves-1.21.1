        ...
        try {
            ...
            if (entityIn instanceof LivingEntity living) {
                ...
                if (render instanceof LivingEntityRenderer<?, ?> renderer && renderer.getModel() != null) {
                    ...
                    VertexConsumer ivertexbuilder = bufferIn.getBuffer(NeoForgeRenderTypes.getUnlitTranslucent(render.getTextureLocation(entityIn)));
                    ...
                    int argb = ((int)(transparency * 255) << 24) | ((int)(0.3F * 255) << 16) | ((int)(0.16F * 255) << 8) | (int)(0.2F * 255);
                    model.renderToBuffer(matrixStack, ivertexbuilder, 240, OverlayTexture.NO_OVERLAY, argb);
                    matrixStack.popPose();
                    if (model instanceof HumanoidModel<?> humanoidModel) {
