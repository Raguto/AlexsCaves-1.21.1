...
public class VoidBeingEyeParticle extends Particle {
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float partialTick) {
        ...
        VertexConsumer portalStatic = multibuffersource$buffersource.getBuffer(NeoForgeRenderTypes.getUnlitTranslucent(TEXTURES[textureIndex]));
        ...
        float f6 = 1;
        int j = 240;
        portalStatic.addVertex(avector3f[0].x(), avector3f[0].y(), avector3f[0].z()).setColor((int)(this.rCol * 255), (int)(this.gCol * 255), (int)(this.bCol * 255), (int)(this.alpha * 255)).setUv(f8, f6).setOverlay(OverlayTexture.NO_OVERLAY).setUv2(j & 0xFFFF, j >> 16).setNormal(posestack$pose, 0.0F, -1.0F, 0.0F);
        portalStatic.addVertex(avector3f[1].x(), avector3f[1].y(), avector3f[1].z()).setColor((int)(this.rCol * 255), (int)(this.gCol * 255), (int)(this.bCol * 255), (int)(this.alpha * 255)).setUv(f8, f5).setOverlay(OverlayTexture.NO_OVERLAY).setUv2(j & 0xFFFF, j >> 16).setNormal(posestack$pose, 0.0F, -1.0F, 0.0F);
        portalStatic.addVertex(avector3f[2].x(), avector3f[2].y(), avector3f[2].z()).setColor((int)(this.rCol * 255), (int)(this.gCol * 255), (int)(this.bCol * 255), (int)(this.alpha * 255)).setUv(f7, f5).setOverlay(OverlayTexture.NO_OVERLAY).setUv2(j & 0xFFFF, j >> 16).setNormal(posestack$pose, 0.0F, -1.0F, 0.0F);
        portalStatic.addVertex(avector3f[3].x(), avector3f[3].y(), avector3f[3].z()).setColor((int)(this.rCol * 255), (int)(this.gCol * 255), (int)(this.bCol * 255), (int)(this.alpha * 255)).setUv(f7, f6).setOverlay(OverlayTexture.NO_OVERLAY).setUv2(j & 0xFFFF, j >> 16).setNormal(posestack$pose, 0.0F, -1.0F, 0.0F);
