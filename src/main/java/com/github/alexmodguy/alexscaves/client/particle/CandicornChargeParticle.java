...
public class CandicornChargeParticle extends TextureSheetParticle {
    ...
    private void renderSignal(VertexConsumer consumer, Camera camera, float partialTicks, Consumer<Quaternionf> rots) {
        ...
        consumer.addVertex((float) avector3f[0].x(), (float) avector3f[0].y(), (float) avector3f[0].z()).setUv(f7, f5).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);
        consumer.addVertex((float) avector3f[1].x(), (float) avector3f[1].y(), (float) avector3f[1].z()).setUv(f7, f4).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);
        consumer.addVertex((float) avector3f[2].x(), (float) avector3f[2].y(), (float) avector3f[2].z()).setUv(f6, f4).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);
        consumer.addVertex((float) avector3f[3].x(), (float) avector3f[3].y(), (float) avector3f[3].z()).setUv(f6, f5).setColor(this.rCol, this.gCol, this.bCol, this.alpha).setLight(j);
    }
