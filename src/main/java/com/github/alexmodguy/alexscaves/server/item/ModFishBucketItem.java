...
public class ModFishBucketItem extends MobBucketItem {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> tooltip, TooltipFlag flagIn) {
        EntityType fishType = (EntityType) this.fishTypeSupplier.get();
    }
    ...
    private void spawnFish(ServerLevel serverLevel, ItemStack stack, BlockPos pos) {
        Entity entity = ((EntityType) this.fishTypeSupplier.get()).spawn(serverLevel, stack, (Player) null, pos, MobSpawnType.BUCKET, true, false);
