...
public class ACCreativeTabRegistry {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CANDY_CAVITY = DEF_REG.register("candy_cavity", () -> CreativeModeTab.builder()
            ...
            .displayItems((enabledFeatures, output) -> {
                ...
                BuiltInRegistries.POTION.holders().filter(holder -> !holder.value().getEffects().isEmpty() && !holder.value().hasInstantEffects()).forEach(holder -> output.accept(ACEffectRegistry.createJellybean(holder)));
