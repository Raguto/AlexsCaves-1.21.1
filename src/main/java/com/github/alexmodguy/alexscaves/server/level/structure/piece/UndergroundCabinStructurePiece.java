...
public class UndergroundCabinStructurePiece extends UndergroundTemplateStructurePiece {
    ...
    protected void handleDataMarker(String string, BlockPos pos, ServerLevelAccessor accessor, RandomSource random, BoundingBox box) {
        ...
        switch (string) {
            case "loot_chest":
                net.minecraft.resources.ResourceKey<net.minecraft.world.level.storage.loot.LootTable> chestLoot = pickedBiome == null ? BuiltInLootTables.SIMPLE_DUNGEON : net.minecraft.resources.ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath(AlexsCaves.MODID, "chests/underground_cabin_" + pickedBiome.location().getPath()));
