...
public class GingerbarrelBlockEntity extends RandomizableContainerBlockEntity {
    ...
    protected void saveAdditional(CompoundTag p_187459_, net.minecraft.core.HolderLookup.Provider registries) {
    ...
    @Override
    protected void loadAdditional(CompoundTag p_155055_, net.minecraft.core.HolderLookup.Provider registries) {
