    ...
    public static void tick(Level level, BlockPos blockPos, BlockState state, TeslaBulbBlockEntity entity) {
        ...
        if (entity.exploding) {
            if (entity.explodeProgress == 10.0F) {
                ...
                for (LivingEntity entity1 : level.getEntitiesOfClass(LivingEntity.class, new AABB(Vec3.atLowerCornerOf(blockPos.offset(-5, -5, -5)), Vec3.atLowerCornerOf(blockPos.offset(5, 5, 5))))) {
