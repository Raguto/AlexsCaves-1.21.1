...
public class TripodfishEntity extends WaterAnimal implements Bucketable {
    ...
    public void saveToBucketTag(@Nonnull ItemStack bucket) {
        ...
        net.minecraft.world.item.component.CustomData customData = net.minecraft.world.item.component.CustomData.of(platTag);
        bucket.set(net.minecraft.core.component.DataComponents.BUCKET_ENTITY_DATA, customData);
    }
    ...
    public void loadFromBucketTag(@Nonnull CompoundTag compound) {
        // In 1.21, bucket data is stored differently via DataComponents
