...
public class SeaPigEntity extends WaterAnimal implements Bucketable {
    ...
    public static final ResourceKey<LootTable> DIGESTION_LOOT_TABLE = ResourceKey.create(net.minecraft.core.registries.Registries.LOOT_TABLE, ResourceLocation.fromNamespaceAndPath("alexscaves", "gameplay/sea_pig_digestion"));
