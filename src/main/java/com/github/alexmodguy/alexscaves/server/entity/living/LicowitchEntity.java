...
public class LicowitchEntity extends Monster implements IAnimatedEntity {
    ...
    private static EntityDataAccessor<Optional<Vec3>> TELEPORTING_TO_POS = SynchedEntityData.defineId(LicowitchEntity.class, ACEntityDataRegistry.OPTIONAL_VEC_3.get());
