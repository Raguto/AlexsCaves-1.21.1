...
public class AlexsCavesBoatEntity extends Boat implements AlexsCavesBoat {
    ...
    private static final EntityDataAccessor<Integer> AC_BOAT_TYPE = SynchedEntityData.defineId(AlexsCavesBoatEntity.class, EntityDataSerializers.INT);
    
    // Track fall damage state locally
    private double acLastYd;
    private Boat.Status acStatus;
