...
public class GalenaGauntletItem extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand interactionHand) {
        ...
        boolean crystallization = itemstack.getEnchantmentLevel(player.registryAccess().lookupOrThrow(net.minecraft.core.registries.Registries.ENCHANTMENT).getOrThrow(ACEnchantmentRegistry.CRYSTALLIZATION)) > 0;
    ...
    public void onUseTick(Level level, LivingEntity living, ItemStack stack, int timeUsing) {
        ...
        boolean crystallization = stack.getEnchantmentLevel(living.registryAccess().lookupOrThrow(net.minecraft.core.registries.Registries.ENCHANTMENT).getOrThrow(ACEnchantmentRegistry.CRYSTALLIZATION)) > 0;
