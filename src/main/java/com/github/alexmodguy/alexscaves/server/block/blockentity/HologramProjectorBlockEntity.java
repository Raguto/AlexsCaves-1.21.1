...
public class HologramProjectorBlockEntity extends BlockEntity {
    ...
    public AABB getRenderBoundingBox() {
        ...
        return new AABB(net.minecraft.world.phys.Vec3.atLowerCornerOf(pos.offset(-1, -1, -1)), net.minecraft.world.phys.Vec3.atLowerCornerOf(pos.offset(2, 2, 2))).inflate(Math.max(f - 0.5F, 1F));
    }
    ...
    public CompoundTag getUpdateTag(net.minecraft.core.HolderLookup.Provider registries) {
        ...
        if (this.entityType != null) {
            compoundtag.putString("EntityType", net.minecraft.core.registries.BuiltInRegistries.ENTITY_TYPE.getKey(this.entityType).toString());
        }
        if (this.entityTag != null) {
